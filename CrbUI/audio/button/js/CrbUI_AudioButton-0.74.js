...
(function()
{
	...
	function h(b) {
		...
		this.f = e.JQUERY('<img src="' + e.PATH + 'CrbUI/audio/button/img/Play.png" width="' + this.size + '" height="' + this.size + '" style="position:absolute; top:0px; left:0px;" />');
		this.j = 2 * Math.PI;
	...
	function j(b, c) {
		c ? e.JQUERY(b.f).attr("src", e.PATH + "CrbUI/audio/button/img/Pause.png") : e.JQUERY(b.f).attr("src", e.PATH + "CrbUI/audio/button/img/Play.png")
	}
	h.prototype.m = function () {
		e.JQUERY(this.f).attr("src") == e.PATH + "CrbUI/audio/button/img/Play.png" ? CrbUI_AP.play(this) : CrbUI_AP.stop(this)
	};
